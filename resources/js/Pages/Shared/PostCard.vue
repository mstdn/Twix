<template>
    <div
        ...
        <div class="pl-16">
            ...
            <div v-if="post.media !== null" class="carousel rounded-box my-3 mr-2 rounded-2xl">
            ...
            <div v-if="post.video !== null" class="flex mb-4 mr-2">
                <div v-for="(item, index) in post.video" :key="index">
                    <div class="w-full">
                        <div class="h-full">
                            <video class="aspect-auto" controls crossorigin playsinline>
                                    ...
                                    <PopoverPanel
                                        ...
                                        <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                                            <div class="bg-gray-50 p-2">
                                                ...
                                                <Link v-if="post.delete === true" @click="destroy(post.id)" method="post"
