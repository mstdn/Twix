    ...
    <div>
        <div class="w-68 xs:w-88 xl:w-275 h-screen">
            <div class="flex flex-col h-screen xl:pr-3 fixed overflow-y-auto w-68 xs:w-88 xl:w-275">
                ...
                <!-- Nav logged-in -->
                <nav v-if="$page.props.auth.user" class="mt-5">
                    <NavLink href="/" :active="$page.component === 'Timelines/Home'">
                    ...
                    <NavLink href="/explore" :active="$page.component === 'Timelines/Explore'">
                ...
                <nav v-else class="mt-5">
                    ...
                    <span class="hidden xl:block ml-4 font-bold text-md">Login</span>
                    </Link>
                    ...
                    <span class="hidden xl:block ml-4 font-bold text-md">Signup</span>
                    </Link>
